...
cp -f "$KERNEL_DIR/build/nh/scripts/action.sh" "$STAGE_DIR"
cp -f "$KERNEL_DIR/build/nh/scripts/customize.sh" "$STAGE_DIR"
cp -f "$KERNEL_DIR/build/nh/scripts/boot-completed.sh" "$STAGE_DIR"
cp -f "$KERNEL_DIR/build/nh/scripts/load_modules.sh" "$STAGE_DIR"
